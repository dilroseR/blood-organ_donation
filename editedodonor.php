...
$id=$_POST['id'];
//update query
$qry = "update organ_donor set fullname='$fullname', weight='$weight', height='$height',bloodgrp='$bloodgrp',organdonate='$organdonate',state='$state',town='$town',pincode='$pincode' ,pno='$pno', gender='$gender'  where id='$id'";
