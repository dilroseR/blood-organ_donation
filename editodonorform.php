...
$id=$_GET['id'];
$qry= "select * from organ_donor where id='$id'";
...
while($row=mysqli_fetch_array($result)){
    ?>
        ...
        <form role="form" action = "editedodonor.php" method = "post">
          <div class="box-body">
            ...
            <div class="form-group">
              ...
              <div class="form-group">
                <label for="exampleInputPassword1">Organ Donate</label>
                <input type="text" class="form-control" name="organdonate" placeholder="organ name" value='<?php echo $row['organdonate']; ?>' required>
              </div>
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="town" placeholder=" " value='<?php echo $row['town']; ?>' required>
              </div>

              <div class="form-group">
                <label for="exampleInputPassword1">Pincode</label>
                <input type="text" class="form-control" name="pincode" placeholder=" " value='<?php echo $row['pincode']; ?>' required>
              </div>
