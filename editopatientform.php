...
$id=$_GET['id'];
$qry= "select * from organ_patient where id='$id'";
...
while($row=mysqli_fetch_array($result)){
    ?>
        ...
        <form role="form" action = "editedopatient.php" method = "post">
          <div class="box-body">
            ...
            <div class="form-group">
              ...
              <div class="form-group">
                <label for="exampleInputPassword1">Need Of Organ</label>
                <input type="text" class="form-control" name="need_of_organ" placeholder="need of organ" value='<?php echo $row['need_of_organ']; ?>' required>
              </div>
