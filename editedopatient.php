...
$state = $_POST["state"];
$city = $_POST["city"];
$need_of_organ= $_POST["need_of_organ"];
$pno = $_POST["pno"];
$gender = $_POST["gender"];
$id=$_POST['id'];
//update query
$qry = "update organ_patient set fullname='$fullname', weight='$weight', height='$height',bloodgrp='$bloodgrp',need_of_organ='$need_of_organ',state='$state',city='$city',pno='$pno', gender='$gender'  where id='$id'";
